      ...
      <SkipNavContent>
        <div className={utilityStyles.content}>
          ...
          <p>
            ...
            is to contribute to the <ExternalLink>Patreon</ExternalLink>. This
            project isn&apos;t trying to make a profit. We&apos;re just looking
            to offset any costs hosting a website.
          </p>
          <p>
